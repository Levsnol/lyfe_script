...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Lyfe",Text = "loading",Duration = 3.6})
...
combatVisuals:Label({ Name = "Aim Assist (for legit niggers)" })
...
local soundsMisc= pageMisc:MultiSection({ Sections = {"Sounds"}, Side = "Left", Size = 180 })
...
autobuyMisc:Toggle({Name = "Auto Buy (BROKEN WAIT FOR UPDATE)", Default = false, Pointer = "autobuyActive", callback = function(bool)
...
settingsMenu:Textbox({Text = "Lyfe", PlaceHolder = "Custom Menu Name", Pointer = "custommenuname", Middle = false, ResetOnFocus = false, callback = function(name)
...
settingsMenu:Textbox({Text = "Lyfe V1 | {fps} | {ping} | {time} | {date}", PlaceHolder = "Watermark Data",Pointer = "watermarkData", Middle = false, ResetOnFocus = false})
...
settingsTheme:Colorpicker({Name = "Silent Aim and Target Aim Accent", Info = "UI Accent", Default = Color3.fromRGB(168,122,207), Pointer = "uiindev", callback = function(color) library:UpdateColor("indevcolor", color) end})
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Lyfe V1 ",Text = string.format("Took %ss to load", math.round((tick() - loadtick)) * 1000 / 1000),Duration = 3.6})
