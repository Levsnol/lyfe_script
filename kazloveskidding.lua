...
Wait(2)
--
local Window = ui:NewWindow{window = {Name = [[<b>lyfe.<font color="rgb(220, 20, 60)">yeat</font></b>]], Description = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name}, User = {Name = LocalPlayer.Name,Role = 'kazs skidded test🫡'}}
