...
}, 
{
	...
	["ShitTalk"] = {
		["Lynx"] = {
			"💀",
			"bro u need to become unlegit",
			"tap in",
			"Here is a wild dahoodian in its habitat ",
			"on the floor?",
			"sleep tight",
			"foot to skull again",
			"spin"
...
Wait(2)
--
local Window = ui:NewWindow{window = {Name = [[<b>lyfe.<font color="rgb(220, 20, 60)">yeat</font></b>]], Description = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name}, User = {Name = LocalPlayer.Name,Role = 'zurs testing build'}}
...
-- 
ui:Notify{text = "lyfe.yeat has loaded (skid beta) ".. Round(tostring(tick() - utility.LastTick)).. " seconds !", time = 5, style = "loading"}